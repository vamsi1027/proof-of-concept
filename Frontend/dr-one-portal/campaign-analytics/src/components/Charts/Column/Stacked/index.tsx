...
const Stacked: React.FunctionComponent<Props> = ({ data }) => {
  const [idChart] = React.useState(CreateRandomIdChart("Stacked"));
  ...
  return <div id={idChart} style={{ height: "calc(100% - 4rem)" }}></div>;
};
